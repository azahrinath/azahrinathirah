...
<body>
    ...
    <!-- Form Input -->
    <section id="input-form" class="input-form">
        <div class="container">
            <center><h2>Place an Order</h2>
            <p>Fill out the form below to place your order.</p></center><br>
            ...
            <div id="order-result" style="display: none;">
                ...
                <table>
                    ...
                    <tr>
                        <th>Date and Time</th>
                        <td><span id="result-datetime"></span></td>
                    </tr>
                    <tr>
                        <th>How many people</th>
                        <td><span id="result-people"></span></td>
                    </tr>
                    <tr>
                        <th>Message / Special Requirements</th>
                        <td><span id="result-message"></span></td>
                    </tr>
                </table>
                <button onclick="hideOrderResult()">Tutup</button>
            </div>
